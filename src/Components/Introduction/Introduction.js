...
const Introduction = () => {
    ...
    return (
        <div className='intro flex flex-col md:flex-row items-center justify-between w-full px-4 sm:px-6 md:px-8 lg:px-10 gap-4 sm:gap-6 md:gap-8 text-white my-6 sm:my-8 md:my-10 lg:my-14 py-6 sm:py-8 md:py-10 lg:py-14 min-h-0 md:min-h-0 lg:min-h-screen'>
            <div className='flex-1 flex flex-col items-center max-w-xs sm:max-w-sm md:max-w-md mx-auto md:mx-0' data-aos="zoom-y-out">
                ...
                <div className='flex justify-center w-full gap-3 sm:gap-4 mt-3 sm:mt-4 md:mt-5' data-aos="zoom-y-out">
            ...
            <div className='w-full md:w-2/3 mt-6 md:mt-0' data-aos="zoom-y-out">
                ...
                <p className='mt-3 sm:mt-4 md:mt-5 text-sm sm:text-base md:text-lg text-center md:text-left'>
                    Looking for a top-notch web developer to revamp your hotel's website? Look no further than Niket Shukla. With years of experience and a keen eye for design, Niket can take your site to the next level, helping you attract more visitors and boost your bookings.
                </p>
            </div>
        </div>
    )
